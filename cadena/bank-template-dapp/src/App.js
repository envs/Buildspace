...
function App() {
  ...
  const contractAddress = '0xA48a1400a3433D1Dc957FE7aFEf68f8A5FeBD88B';
  ...
  const checkIfWalletIsConnected = async () => {
    try {
      if (window.ethereum) {
        ...
        setError("Please install a MetaMask Wallet to use the bank services.");
        ...
        <div className="mt-7 mb-9">
          <form className="form-style">
            ...
            <button
              ...
              onClick={deposityMoneyHandler}>Deposit ETH</button>
          </form>
        </div>
